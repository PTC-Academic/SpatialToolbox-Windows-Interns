...
exports.traceClientResponseMessage = exports.traceClientRequestMessage = exports.traceResponseMessage = exports.traceRequestMessage = exports.isGoodish = exports._dump_client_transaction_statistics = exports._dump_transaction_statistics = exports.dumpSecurityHeader = exports.doTraceStatistics = exports.doTraceClientResponseContent = exports.doTraceClientRequestContent = exports.doTraceClientMessage = exports.doPerfMonitoring = exports.doTraceResponse = exports.doTraceRequest = exports.doTraceMessage = void 0;
...
exports.doTraceMessage = serverFlag.match(/TRACE/);
...
function traceRequestMessage(request, channelId, instance) {
    if (exports.doTraceMessage) {
        ...
        console.log(chalk.green(node_opcua_utils_1.timestamp(), "   >>>>> ------ S"), instance.toString().padStart(3), channelId.toString().padStart(3), requestId.toString().padStart(8), chalk.yellow(request.schema.name.padEnd(nameLength)), extra, size);
        if (exports.doTraceRequest) {
...
function traceResponseMessage(response, channelId, instance) {
    ...
    if (exports.doTraceMessage) {
        ...
        console.log(chalk.green.bold(node_opcua_utils_1.timestamp(), "   <<<<< ------ S"), instance.toString().padStart(3), channelId.toString().padStart(3), requestId.toString().padStart(8), chalk.green.bold(response.schema.name.padEnd(nameLength)), extra, size, statusCodeToString(response.responseHeader.serviceResult));
        if (exports.doTraceResponse) {
...
function traceClientRequestMessage(request, channelId, instance) {
    ...
    const size = evaluateBinarySize(request);
    const requestId = request.requestHeader.requestHandle;
    console.log(chalk.cyan(node_opcua_utils_1.timestamp(), "  >>>>>> ------ C"), instance.toString().padStart(3), channelId.toString().padStart(3), requestId.toString().padStart(8), request.schema.name.padEnd(nameLength), extra, size);
}
...
function traceClientResponseMessage(response, channelId, instance) {
    ...
    const size = evaluateBinarySize(response);
    const requestId = response.responseHeader.requestHandle;
    console.log(chalk.cyan.bold(node_opcua_utils_1.timestamp(), "  <<<<<< ------ C"), instance.toString().padStart(3), channelId.toString().padStart(3), requestId.toString().padStart(8), response.schema.name.padEnd(nameLength), extra, size, statusCodeToString(response.responseHeader.serviceResult));
}
