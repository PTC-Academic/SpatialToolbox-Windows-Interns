...
export declare class BaseNode extends EventEmitter implements BaseNodePublic {
    onFirstBrowseAction?: (this: BaseNodePublic) => Promise<void>;
     ...
     */
    get modellingRule(): ModellingRuleType;
