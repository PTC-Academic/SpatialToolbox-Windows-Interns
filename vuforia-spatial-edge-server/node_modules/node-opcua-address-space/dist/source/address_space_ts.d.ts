...
import { AccessLevelFlag, AttributeIds, BrowseDirection, LocalizedText, LocalizedTextLike, NodeClass, QualifiedName, QualifiedNameLike } from "node-opcua-data-model";
...
import { Argument, ArgumentOptions, AxisInformationOptions, AxisScaleEnumeration, BrowsePath, BrowsePathResult, BuildInfo, CallMethodResultOptions, EUInformation, EUInformationOptions, Range, RangeOptions, ReferenceDescription, ServerDiagnosticsSummaryDataType, ServerState, ServerStatusDataType, SessionDiagnosticsDataType, SessionSecurityDiagnosticsDataType, SignedSoftwareCertificate, SimpleAttributeOperand } from "node-opcua-types";
...
export declare type BindVariableOptions = BindVariableOptionsVariation1 | BindVariableOptionsVariation2 | BindVariableOptionsVariation3;
export declare type ContinuationPoint = Buffer;
...
export interface UAVariable extends BaseNode, VariableAttributes, IPropertyAndComponentHolder {
    ...
    writeValue(context: SessionContext, dataValue: DataValueOptions, indexRange: string | NumericRange | null, callback: StatusCodeCallback): void;
    writeValue(context: SessionContext, dataValue: DataValueOptions, callback: StatusCodeCallback): void;
    writeValue(context: SessionContext, dataValue: DataValueOptions, indexRange?: string | NumericRange | null): Promise<StatusCode>;
    ...
    historyRead(context: SessionContext, historyReadDetails: HistoryReadDetails, indexRange: NumericRange | null, dataEncoding: QualifiedNameLike | null, continuationPoint?: ContinuationPoint): Promise<HistoryReadResult>;
    historyRead(context: SessionContext, historyReadDetails: HistoryReadDetails, indexRange: NumericRange | null, dataEncoding: QualifiedNameLike | null, continuationPoint: ContinuationPoint | null, callback: CallbackT<HistoryReadResult>): void;
...
export declare type PseudoVariant = PseudoVariantNull | PseudoVariantString | PseudoVariantBoolean | PseudoVariantNodeId | PseudoVariantDateTime | PseudoVariantByteString | PseudoVariantDuration | PseudoVariantLocalizedText | PseudoVariantStatusCode | PseudoVariantNumber | PseudoVariantExtensionObject | PseudoVariantExtensionObjectArray;
...
export declare class UAMethod extends BaseNode {
     ...
     *
     */
    _getExecutableFlag?: (sessionContext: SessionContext) => boolean;
    setPermissions(permissions: Permissions): void;
     ...
     * @param callback
     */
    execute(inputArguments: VariantLike[] | null, context: SessionContext, callback: MethodFunctorCallback): void;
...
export declare type AddStateVariableOptionals = "EffectiveDisplayName" | "Name" | "Number" | string;
export interface AddStateVariableOptions extends AddVariableOptionsWithoutValue {
    id?: any;
    optionals?: AddStateVariableOptionals[];
}
export declare type AddTwoStateVariableOptionals = AddStateVariableOptionals | "TransitionTime" | "EffectiveTransitionTime" | "TrueState" | "FalseState";
...
export interface YArrayItemVariable extends UAVariable {
    ...
    title: UAVariableT<LocalizedText, DataType.LocalizedText>;
    xAxisDefinition: UAVariableT<AxisInformationOptions, DataType.ExtensionObject>;
    instrumentRange: UAVariableT<Range, DataType.ExtensionObject>;
    axisScaleType: UAVariableT<number, DataType.UInt32>;
}
...
export interface UAVariableT<T, DT extends DataType> extends UAVariable {
    ...
    writeValue(context: SessionContext, dataValue: DataValueOptionsT<T, DT>, indexRange: NumericRange | null, callback: (err: Error | null, statusCode?: StatusCode) => void): void;
    writeValue(context: SessionContext, dataValue: DataValueOptionsT<T, DT>, callback: (err: Error | null, statusCode?: StatusCode) => void): void;
...
export interface HistoricalDataConfiguration extends UAObject {
    ...
    maxTimeInterval: UAVariableT<number, DataType.Double>;
    minTimeInterval: UAVariableT<number, DataType.Double>;
...
export interface Namespace {
    ...
    addTransition(component: StateMachine | StateMachineType, fromState: string, toState: string, transitionNumber: number): Transition;
}
export declare type UAClonable = UAObject | UAVariable | UAMethod;
