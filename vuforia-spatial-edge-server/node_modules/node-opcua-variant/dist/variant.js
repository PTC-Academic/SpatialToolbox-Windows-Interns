...
class Variant extends node_opcua_factory_1.BaseUAObject {
    constructor(options) {
        ...
        this.value = node_opcua_factory_1.initialize_field(schema.fields[2], options2.value);
...
function variantToString(self, options) {
    ...
    if (self.arrayType === VariantArrayType_enum_1.VariantArrayType.Scalar) {
        ...
        if (!self.value) {
            ...
            const a = [];
            node_opcua_assert_1.assert(Array.isArray(self.value) || self.value.buffer instanceof ArrayBuffer);
...
function __check_same_array(arr1, arr2) {
    ...
    if (!oldNodeVersion && arr1.buffer) {
        ...
        node_opcua_assert_1.assert(arr2.buffer && __type(arr2.buffer) === "[object ArrayBuffer]");
