...
function _serverEndpointsForCreateSessionResponse(server, endpointUrl, serverUri) {
    ...
    return server
        ...
        .filter((e) => node_opcua_utils_1.matchUri(e.endpointUrl, endpointUrl))
...
function _registerServer(discoveryServerEndpointUrl, isOnline, outer_callback) {
    ...
    node_opcua_assert_1.assert(typeof isOnline === "boolean");
    const self = this;
...
function getNodeIds(nodesToBrowse) {
...
class OPCUAServer extends base_server_1.OPCUABaseServer {
    constructor(options) {
        ...
        if (!options.userCertificateManager) {
            this.userCertificateManager = node_opcua_certificate_manager_1.getDefaultCertificateManager("UserPKI");
        }
        else {
        ...
        this._delayInit = () => __awaiter(this, void 0, void 0, function* () {
            ...
            const hostname = node_opcua_hostname_1.getFullyQualifiedDomainName();
    ...
    verifyClientSignature(session, channel, clientSignature) {
        ...
        const result = node_opcua_secure_channel_1.verifySignature(serverCertificate, session.nonce, clientSignature, clientCertificate, securityPolicy);
        return result;
    }
    ...
    _on_CreateSessionRequest(message, channel) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (node_opcua_secure_channel_1.nonceAlreadyBeenUsed(request.clientNonce)) {
    ...
    _apply_on_SessionObject(ResponseClass, message, channel, action_to_perform) {
        return __awaiter(this, void 0, void 0, function* () {
            node_opcua_assert_1.assert(typeof action_to_perform === "function");
            ...
            if (message.session.keepAlive) {
                node_opcua_assert_1.assert(typeof message.session.keepAlive === "function");
    ...
    _on_BrowseRequest(message, channel) {
        ...
        this._apply_on_SessionObject(node_opcua_service_browse_1.BrowseResponse, message, channel, (session, sendResponse, sendError) => {
            ...
            const f = util_1.callbackify(server.engine.browseWithAutomaticExpansion).bind(server.engine);
   ...
   */
    _on_WriteRequest(message, channel) {
        ...
        node_opcua_assert_1.assert(!request.nodesToWrite || Array.isArray(request.nodesToWrite));
        this._apply_on_SessionObject(node_opcua_service_write_1.WriteResponse, message, channel, (session, sendResponse, sendError) => {
            ...
            server.engine.write(context, request.nodesToWrite, (err, results) => {
                ...
                node_opcua_assert_1.assert(Array.isArray(results));
        ...
        this._apply_on_Subscription(node_opcua_service_subscription_1.CreateMonitoredItemsResponse, message, channel, (session, subscription, sendResponse, sendError) => __awaiter(this, void 0, void 0, function* () {
            ...
            const resultsPromise = request.itemsToCreate.map((monitoredItemCreateRequest) => __awaiter(this, void 0, void 0, function* () {
                ...
                if (monitoredItem) {
                    ...
                    yield subscription.postCreateMonitoredItem(monitoredItem, monitoredItemCreateRequest, createResult);
                }
                return createResult;
            }));
            const results = yield Promise.all(resultsPromise);
    ...
    createEndpointDescriptions(serverOption, endpointOptions) {
        ...
        /* istanbul ignore next */
        if (!endpointOptions.hasOwnProperty("port") ||
