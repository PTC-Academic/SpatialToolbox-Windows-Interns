...
const default_server_info = {
    ...
    applicationUri: node_opcua_common_1.makeApplicationUrn(os.hostname(), "NodeOPCUA-Server"),
...
function cleanupEndpoint(endpoint) {
    if (endpoint._on_new_channel) {
        node_opcua_assert_1.assert(typeof endpoint._on_new_channel === "function");
    ...
    if (endpoint._on_close_channel) {
        node_opcua_assert_1.assert(typeof endpoint._on_close_channel === "function");
    ...
    if (endpoint._on_connectionRefused) {
        node_opcua_assert_1.assert(typeof endpoint._on_connectionRefused === "function");
    ...
    if (endpoint._on_openSecureChannelFailure) {
        node_opcua_assert_1.assert(typeof endpoint._on_openSecureChannelFailure === "function");
...
class OPCUABaseServer extends node_opcua_common_1.OPCUASecureObject {
    constructor(options) {
        ...
        if (!options.serverCertificateManager) {
            options.serverCertificateManager = node_opcua_certificate_manager_1.getDefaultCertificateManager("PKI");
        }
        ...
        node_opcua_assert_1.assert(!this.serverInfo.applicationName.toString().match(/urn:/), "application name cannot be a urn");
        ...
        this._preInitTask.push(() => __awaiter(this, void 0, void 0, function* () {
            const fqdn = yield node_opcua_hostname_1.extractFullyQualifiedDomainName();
        }));
        this._preInitTask.push(() => __awaiter(this, void 0, void 0, function* () {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            if (!fs.existsSync(this.certificateFile)) {
                ...
                yield this.serverCertificateManager.createSelfSignedCertificate({
                    ...
                    subject: node_opcua_certificate_manager_1.makeSubject(this.serverInfo.applicationName.text, hostname),
                    startDate: new Date(),
     ...
     */
    start(done) {
        node_opcua_assert_1.assert(typeof done === "function");
        this.startAsync()
            .then(() => done(null))
            .catch((err) => done(err));
    }
    ...
    startAsync() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const self = this;
            node_opcua_assert_1.assert(Array.isArray(this.endpoints));
            node_opcua_assert_1.assert(this.endpoints.length > 0, "We need at least one end point");
    ...
    on_request(message, channel) {
        ...
        try {
            ...
            node_opcua_debug_2.displayTraceFromThisProjectOnly(err);
    ...
    _get_endpoints(endpointUrl) {
        ...
        for (const endPoint of this.endpoints) {
            ...
            const epFiltered = endpointUrl ? ep.filter((e) => node_opcua_utils_1.matchUri(e.endpointUrl, endpointUrl)) : ep;
...
function makeServiceFault(statusCode, messages) {
    ...
    node_opcua_assert_1.assert(Array.isArray(messages));
