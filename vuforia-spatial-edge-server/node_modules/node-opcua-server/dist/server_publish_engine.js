...
function _assertValidPublishData(publishData) {
    ...
    node_opcua_assert_1.assert(typeof publishData.serverTimeWhenReceived === "number");
...
class ServerSidePublishEngine extends events_1.EventEmitter {
    ...
    findLateSubscriptionsSortedByAge() {
        ...
        late_subscriptions = underscore_1.sortBy(late_subscriptions, "timeToExpiration");
    ...
    _cancelTimeoutRequests() {
        ...
        const parts = underscore_1.partition(this._publish_request_queue, timeout_filter);
