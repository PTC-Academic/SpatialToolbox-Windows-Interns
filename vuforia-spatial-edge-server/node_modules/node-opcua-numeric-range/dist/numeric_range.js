...
class NumericRange {
    ...
    toString() {
        function array_range_to_string(values) {
            node_opcua_assert_1.assert(Array.isArray(values));
...
function slice(arr, start, end) {
    ...
    if (arr.buffer instanceof ArrayBuffer) {
        ...
        node_opcua_assert_1.assert(typeof arr.slice === "function");
...
function extract_array_range(array, low_index, high_index) {
    node_opcua_assert_1.assert(isFinite(low_index) && isFinite(high_index));
...
function extract_matrix_range(array, rowRange, colRange, dimension) {
    node_opcua_assert_1.assert(Array.isArray(rowRange) && Array.isArray(colRange));
    if (array.length === 0) {
        return {
            array: [],
...
function assert_array_or_buffer(array) {
    node_opcua_assert_1.assert(Array.isArray(array) || array.buffer instanceof ArrayBuffer || array instanceof Buffer);
}
...
function coerceNumericRange(value) {
    ...
    node_opcua_assert_1.assert(typeof value === "string" || Array.isArray(value));
