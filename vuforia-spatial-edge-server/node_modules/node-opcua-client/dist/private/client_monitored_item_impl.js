...
class ClientMonitoredItemImpl extends events_1.EventEmitter {
    ...
    _prepare_for_monitoring() {
        ...
        node_opcua_assert_1.assert(this.monitoringParameters.clientHandle > 0 && this.monitoringParameters.clientHandle !== 4294967295);
...
client_monitored_item_1.ClientMonitoredItem.create = (subscription, itemToMonitor, monitoringParameters, timestampsToReturn) => {
    return client_subscription_impl_1.ClientMonitoredItem_create(subscription, itemToMonitor, monitoringParameters, timestampsToReturn);
};
