...
class ClientSubscriptionImpl extends events_1.EventEmitter {
    ...
    monitor(...args) {
        ...
        const monitoredItem = ClientMonitoredItem_create(this, itemToMonitor, requestedParameters, timestampsToReturn, (err1, monitoredItem2) => {
            if (err1) {
     ...
     */
    _createMonitoredItem(itemToMonitor, monitoringParameters, timestampsToReturn) {
        /* istanbul ignore next*/
        const monitoredItem = new client_monitored_item_impl_1.ClientMonitoredItemImpl(this, itemToMonitor, monitoringParameters, timestampsToReturn);
        return monitoredItem;
    }
}
exports.ClientSubscriptionImpl = ClientSubscriptionImpl;
function ClientMonitoredItem_create(subscription, itemToMonitor, monitoringParameters, timestampsToReturn, callback) {
    const monitoredItem = new client_monitored_item_impl_1.ClientMonitoredItemImpl(subscription, itemToMonitor, monitoringParameters, timestampsToReturn);
    setImmediate(() => {
